import type { AppSettings, DayNote, DayView, ExtraIncome, GoalHistory, Product, Sale, Video } from '../lib/types'
...
export const demoGoalHistory: GoalHistory[] = [
  { id: 'gh1', day_date: '2000-01-01', goal: 5, created_at: '2000-01-01' },
]
